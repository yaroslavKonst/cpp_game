...
void Video::CreateTextureImage()
{
	...
	stbi_uc* pixels = stbi_load(
		"../src/client/video/textures/test_texture.png",
		&texWidth,
		&texHeight,
		&texChannels,
		STBI_rgb_alpha);
...
void Video::DestroyTextureImage()
{
	vkDestroyImage(device, textureImage, nullptr);
	vkFreeMemory(device, textureImageMemory, nullptr);
}

void Video::CreateTextureImageView()
{
...
void Video::DestroyTextureImageView()
{
...
VkImageView Video::CreateImageView(VkImage image, VkFormat format)
{
	...
	VkImageLayout newLayout)
{
		...
		newLayout == VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL)
	{
		...
		throw std::runtime_error(
			"unsupported layout transition type");
	}
